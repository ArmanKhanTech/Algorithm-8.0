  ...
  return (
    <section className={`${isMobile ? "hero-bg-mobile" : "hero-bg-desktop"}`}>
      ...
      <section className="flex flex-col items-center justify-center w-[100vw] h-[100vh]">
        <section
          className={`-top-24 lg:-top-0 flex md:flex-row flex-col relative z-0`}
        >
          <div
            className={`flex-1 ${styles.flexStart} flex-col justify-center items-center`}
          >
            <motion.div variants={fadeIn("down", "spring", 0.3, 0.75)}>
              <h1
                className={`flex text-center justify-center font-poppins font-semibold text-2xl lg:text-4xl text-white drop-shadow-[0_1.2px_1.2px_rgba(234,88,12,1.0)]`}
              >
                AIKTC's
              </h1>
            </motion.div>
            <motion.div variants={fadeIn("down", "spring", 0.3, 0.75)}>
              <h1
                className={`flex text-center justify-center px-1 font-poppins font-semibold text-2xl lg:text-4xl text-white drop-shadow-[0_1.2px_1.2px_rgba(234,88,12,1.0)]`}
              >
