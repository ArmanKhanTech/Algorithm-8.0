    ...
    <div className="relative z-0 bg-black overflow-x-hidden">
      <section>
        ...
        <section className="items-center flex justify-center min-h-screen px-2">
          <div
            className={`lg:border-2 lg:border-orange-600 bg-blur flex flex-col rounded-2xl md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-10 items-center`}
          >
            <div>
              <Lottie
            ...
            <div className={`md:w-1/2 max-w-sm p-5 lg:p-10`}>
              <div className="flex flex-row">
                ...
                <h1 className="mb-8 ml-2.5 font-extrabold text-4xl">
                  Login or Create Account
                </h1>
              </div>
              <p className="mb-4 text-base font-semibold">
                If your account exists you will be logged in otherwise a new
