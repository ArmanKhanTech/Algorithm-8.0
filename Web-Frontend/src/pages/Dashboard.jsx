            ...
            >
              <fieldset className="grid grid-cols-4 gap-6 p-3 rounded-md shadow-sm">
                <div className="space-y-2 col-span-full lg:col-span-1 ">
                  ...
                  <p className="text-medium">
                    has access of deleting of other members.
                  </p>
                </div>
                <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                  <div className="col-span-full border-b">
                    ...
                    <input
                      ...
                      value={nameLead}
                      disabled="disabled"
                      className="w-full h-8 rounded-md focus:ring bg-inherit"
                    />
                  </div>
                  ...
                  <div className="col-span-full sm:col-span-3 border-b">
                    <label htmlFor="github_profile" className="text-sm">
                      GitHub Profile
                    </label>
                    <input
                      id="github_profile"
                  ...
                  <div className="col-span-full sm:col-span-3 border-b">
                    <label htmlFor="linkdin_profile" className="text-sm">
                      LinkedIn Profile
                    </label>
                    <input
                      id="linkdin_profile"
              ...
              <fieldset className="grid grid-cols-4 gap-6 p-3 rounded-md shadow-sm">
                <div className="space-y-2 col-span-full lg:col-span-1">
                  ...
                  <p
                    className={`${!member2Exists ? "block" : "hidden"} text-medium text-red-500`}
                  >
                    Member 2 dosen't exists
                  </p>
                </div>
                <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                  <div className="col-span-full border-b">
              ...
              <fieldset className="grid grid-cols-4 gap-6 p-3 rounded-md shadow-sm pb-4">
                <div className="space-y-2 col-span-full lg:col-span-1">
                  ...
                  <p
                    className={`${!member3Exists ? "block" : "hidden"} text-medium text-red-500`}
                  >
                    Member 3 dosen't exists
                  </p>
                </div>
                <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                  <div className="col-span-full border-b">
                ...
                <div className="flex flex-col mt-4">
                  {notice.map((item, index) => {
                    return (
                      <div
                        key={index}
                        className="flex flex-col p-3 bg-gradient-to-r from-amber-500 to-orange-900 rounded-lg mb-4"
                      >
                        ...
                        <p className="mt-2 text-white text-lg break-words">
                          {item.notice}
                        </p>
                      </div>
                    );
              ...
              <div className="flex overflow-hidden rounded-lg text-2xl text-white font-bold bg-gradient-to-r from-amber-500 to-orange-900">
                ...
                <div className="flex items-center justify-between flex-1 p-3">
                  <p className="text-2xl font-semibold break-words">
                    {nameLead ? nameLead : "Not Yet Registered"}
                  </p>
                </div>
              </div>
              <div className="flex overflow-hidden rounded-lg text-2xl text-white font-bold bg-gradient-to-r from-amber-500 to-orange-900">
                ...
                <div className="flex items-center justify-between flex-1 p-3">
                  <p className="text-2xl font-semibold break-words">
                    {nameMember2 ? nameMember2 : "Not Yet Registered"}
                  </p>
                </div>
              </div>
              <div className="flex overflow-hidden rounded-lg text-2xl text-white font-bold bg-gradient-to-r from-amber-500 to-orange-900">
                ...
                <div className="flex items-center justify-between flex-1 p-3">
                  <p className="text-2xl font-semibold break-words">
                    {nameMember3 ? nameMember3 : "Not Yet Registered"}
                  </p>
                </div>
              </div>
            </div>
                    ...
                    return (
                      <div key={index} className="flex md:contents">
                        ...
                        <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full overflow-auto">
                          <p className="leading-tight text-justify text-lg font-bold break-words">
                            {item.event}
                          </p>
                        </div>
                      </div>
