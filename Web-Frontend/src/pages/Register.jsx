        ...
        <div>
          <form className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4">
            <fieldset className="border border-orange-600 p-6 rounded-2xl m-3 bg-blur">
              <p
                className={`${membersExists == true ? "block" : "hidden"} text-green-500 text-lg font-bold my-3`}
              >
                {memberCount} member/s already registered.
              </p>
              ...
              <div className="bg-blur rounded-2xl h-full p-4">
                ...
                <ul className="list-disc mt-4 list-inside text-xl">
                  ...
                  <li>
                    ...
                    team name with your team mates so that they can become part
                    of your team.
                  </li>
                  <li>
            ...
            <div className="flex justify-center text-center md:text-left font-bold">
              {isRegistered ? (
                <Link
                  to="/edit"
                  className={`mt-3 mx-2 lg:mx-3 text-lg bg-orange-600 px-4 py-2 text-white uppercase rounded-xl`}
                  style={{
                    width: "100%",
                    display: "flex",
                ...
                <button
                  className={`mt-3 mx-2 lg:mx-3 text-lg bg-orange-600 hover:bg-orange-800 px-4 py-2 text-white uppercase rounded-xl`}
                  type="submit"
                  style={{
                    width: "100%",
                    display: "flex",
