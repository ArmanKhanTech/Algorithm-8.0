...
import 'package:algorithm/screen/user/profile.dart';
import 'package:algorithm/screen/user/report.dart';
import 'package:algorithm/screen/admin/register.dart';
import 'package:algorithm/screen/admin/manage.dart';
import 'package:algorithm/screen/admin/marks.dart';
import 'package:algorithm/screen/hosp/log_activity.dart';
import 'package:algorithm/screen/judge/evaluate.dart';
import 'package:algorithm/screen/web.dart';
import 'package:algorithm/screen/teams/details.dart';
import 'package:algorithm/screen/admin/problems.dart';
import 'package:algorithm/screen/admin/make_annoucements.dart';
import 'package:algorithm/screen/user/announcements.dart';
import 'package:algorithm/screen/auth/login.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  Future<dynamic> openDailog(TeamModel team) {
    return showDialog(
      context: context,
